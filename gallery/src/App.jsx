...
const App = () => {
  ...
  const getData=async()=>{
   const response = await axios.get(`https://picsum.photos/v2/list?page=${index}&limit=13`);
  ...
  return (
   ...
   <div className='flex justify-center items-center p-4 gap-7'>
    ...
    className='bg-red-500 cursor-pointer active:scale-95 text-black rounded px-4 py-2 font-semibold text-sm'>
      Prev</button>
